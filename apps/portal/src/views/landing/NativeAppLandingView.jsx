  ...
  if (normalizedSlug === 'tunestream') {
    ...
    const renderExplore = () => {
      ...
      const handleViewEpk = (c) => {
        ...
        window.location.hash = `#/epk/${username}`;
      };

      return (
        <div style={{ textAlign: 'center' }}>
          <p style={{ color: 'var(--mu)', fontSize: '14px', marginBottom: '24px', textAlign: 'center' }}>Discover new talent and explore their standalone Creator Web Worlds on the Intermaven network.</p>
